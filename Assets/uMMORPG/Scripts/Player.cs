...
public partial class Player : Entity
{
    ...
    string UpdateServer_CASTING()
    {
        ...
        if (EventSkillFinished())
        {
            ...
            // skill should be followed with default attack?
            ...
            // clear next skill in any case. we tried to assign it to current.
            nextSkill = -1;
            ...
            if (entity)
            {
                ...
                if (entity == target && entity != this && entity != activePet)
                {
                    ...
                    if (CanAttack(entity))
                    {
                        ...
                        {
                            agent.stoppingDistance = skills.Count > 0 ? skills[0].castRange : 0;
